...
model_resized = Conv2d_Module_from_3Dto2D_Input_Classifier(height=128, width=128, factor=4, num_class=2)
model_original = Conv2d_Module_from_3Dto2D_Input_Classifier(height=256, width=256, factor=4, num_class=2)
